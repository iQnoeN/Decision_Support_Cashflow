"""
XGBoost Liquidity Classifier Training Pipeline

Trains a multi-class XGBoost Gradient Boosted Trees classifier on the labeled liquidity dataset
...
MODEL_PATH = ML_ROOT / "models" / "xgboost_classifier.pkl"

OUTPUT_DIR = ML_ROOT / "outputs" / "xgboost_classifier"
...
def train_model(
    ...
    """Initialize and fit multi-class XGBoost classifier."""
    model = XGBClassifier(
        n_estimators=100,
        max_depth=6,
        learning_rate=0.1,
...
def main():
    print("=" * 60)
    print("XGBOOST LIQUIDITY CLASSIFIER")
    print("=" * 60)
